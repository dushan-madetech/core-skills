...
//        invigilatorRepository.save(InvigilatorEntity.builder().name("Clark Kent").coreSkills(Arrays.asList(new String[]{expectedBadge})).build());
//        Iterable<InvigilatorEntity> result = invigilatorRepository.findAll();
//
//        assertEquals(expectedName, result.iterator(e.));
//    }
}
